...
CREATE TABLE `admin` (
  ...
  `admin_latest_login` datetime NOT NULL DEFAULT current_timestamp()
...
INSERT INTO `admin` (`admin_id`, `admin_name`, `admin_password`, `admin_latest_login`) VALUES
('yongsin123', 'yongsin', 'yongsin', '2024-01-24 15:29:01');
